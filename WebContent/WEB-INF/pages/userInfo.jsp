...
<html lang="zh-CN">
  ...
  <body>
	...
	<div class="container damu-row">
    	 ...
    	 <form class="form-horizontal" id="order" method="post">
    	<div class="col-md-8 form-group form-group-lg">
    	 	<table class="table table-hover">
    	 		<tr>
    	 			<td>收货人姓名：</td>
    	 			<td><input type="text" id="name" name="receive_name"  class="form-control" value="${user.username}"></td>
    	 		</tr>
    	 		<br>
    	 			<tr>
    	 			<td>收货人地址：</td>
    	 			<td><input type="text" id="address" name="receive_address"  class="form-control" value="${user.address}"></td>
    	 			</tr>
    	 			<br>
    	 				<tr>
    	 				<td>收货人手机号码：</td>
    	 				<td><input type="text" id="phone" name="receive_phone"  class="form-control" value="${user.phone}"></td>
    	 				</tr>
    	 				<br>
    	 				<tr>
    	 				<br>
    	 				...
    	 				<td>
    	 					<input id="btn" class="btn btn-warning" type="button" value="保存"></tr>
    	 				</td>
...
<script src="js/jquery-2.2.4.min.js"></script>
    ...
    $("#btn").click(function(){
    	...
    	$.ajax({
    		...
    		data:{"username":username,"address":address,"phone":phone},
    		type:"POST",

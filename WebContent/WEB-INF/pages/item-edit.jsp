...
<html lang="zh-CN">
  ...
  <body>
	...
	<div class="container damu-row">
    	 ...
    	 <form class="form-horizontal" action="updateForm.do"method="post" id="updateForm" enctype="multipart/form-data">
    	<div class="col-md-8 form-group form-group-lg">
	        ...
	        <tr>
	            <td>商品标题:</td>
	            <td><input class="easyui-textbox" id="title"type="text" name="title" data-options="required:true" style="width: 280px;" value="${item.title}"></input></td>
	       ...
	       <!--  <tr>
	        ...
	        <tr>
	            <td>商品价格:</td>
	            <td><input id="price"class="easyui-textbox" type="text" name="price" data-options="required:true" value="${item.price}"/><span id="pricespan"></span>
	        ...
	        <tr>
	            <td>商品图片:</td>
	            <td>
	            	 <img src="/img/${item.photo}" alt="..." style="width:160px;height:160px;">
	        ...
	        <tr>
	            <td>库存数量:</td>
	            <td><input id="num"class="easyui-textbox" type="text" name="num" data-options="required:true" value="${item.num}"/><span id="numspan"></span></td>
	        ...
	        <tr>
	            <td>商品描述:</td>
	            <td>
	                <textarea id="desc" style="width:800px;height:300px;" name="describ">${item.describ } </textarea>
	            </td> 
	            <span id="limit"></span>
	        </tr>
	        <tr><td>
    	 					<input id="btn" class="btn btn-warning" type="button" value="保存">
    	 				</td></tr>
	    </table>
